...
export const webRoutes = [
  ...
  { method: "GET", path: "/admin/users/delete/{id}", config: accountsController.removeUser },
  ...
  { method: "POST", path: "/location/{id}/uploadimage", config: reportController.uploadImage },
